...
xmlHttp.send("username=" + username+"&idd=admin"); //发送信息
}
</script>
</head>
<body style="background-image: url(./img/register/welcome.jpg);">
	...
	<div align="center" class="searchdiv">
		<form method="post" action="Register?create=admin">
			<table>
				<tr>
					<td>Account:</td>
				...
				<tr>
					<td>Book Manager right:</td>
					<td><select name="BookManager" required="true">
						<option value="1">Yes</option>
						<option value="0">No</option>
					</select></td>
				</tr>
				<tr>
					<td>User Manager right:</td>
					<td><select name="UserManager" required="true">
						<option value="1">Yes</option>
						<option value="0">No</option>
					</select></td>
				</tr>
				<tr>
					<td>Admin Manager right:</td>
					<td><select name="AdminManager" required="true">
						<option value="0">No</option>
						<option value="1">Yes</option>
					</select></td>
				</tr>
