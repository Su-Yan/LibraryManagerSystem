...
/**
 * Servlet implementation class EditRoomConfirm
 */
@WebServlet("/EditRoomConfirm")
public class EditRoomConfirm extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditRoomConfirm() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			lrd.updateRoomInfo(RoomName, RoomFloor, Telephone, BrefIntroduction, OpenTime, CloseTime);
